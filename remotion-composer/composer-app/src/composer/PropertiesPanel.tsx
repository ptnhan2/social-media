...
/** Voice clip timing section (CONTENT-STUDIO-SPEC — the DỰNG layer). The
 *  voice-BIRTH panel (script text, direction, settings, takes, regen, QC)
 *  moved to the Content Studio (/project) — the editor keeps only what
 *  needs timeline neighbors: breathPad retime + (below) gain/fades/mute. */
const VoiceSection: React.FC<{
  ...
  return (
    <div className="ve-prop-voice">
      ...
      <p className="ve-hint">🎛️ Voice direction / takes / regen đã dời sang <b>Content Studio</b> — mở 📄 Project trên header.</p>
    </div>
  );
};
...
export const PropertiesPanel: React.FC<PropertiesPanelProps> = ({
  ...
  return (
    <div className="ve-properties">
      ...
      {activeTab === "audio" ? (
        <div className="ve-prop-section">
          {clip.kind === "voice" ? <VoiceSection clip={clip} onRetimeVoice={onRetimeVoice} /> : null}
          <label className="ve-prop-field">
            <span>Gain dB</span>
