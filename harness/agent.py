...
from harness_tools import render_window, visual_critique, think, update_style, compare_renders, pairwise_verdict, request_keep, copy_render, qa_gate, editor_op, generate_timeline, write_edit_doc
...
_COMMON = dict(
    model=MODEL,
    tools=[render_window, visual_critique, think, update_style, compare_renders, pairwise_verdict, request_keep, copy_render, qa_gate, editor_op, generate_timeline, write_edit_doc],
