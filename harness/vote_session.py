...
# Every pair below passed the pixel-diff gate (verify_vote_pairs.py, 2026-08-21).
PAIRS = [
    {"id": "reveal", "aspect": "motion",
     "knob": "treatments.semantic-diagram.edge.revealDurationSec",
     "a": "0.65", "b": "2",
     "a_file": "cycle_before.mp4", "b_file": "cycle_after.mp4",
     "desc": "tốc độ vẽ đường nối giữa các node (nhanh vs chậm)"},
    {"id": "damping", "aspect": "motion",
     "knob": "treatments.semantic-diagram.entrance.damping",
     "a": "18", "b": "2",
     "a_file": "vs_dm_A.mp4", "b_file": "vs_dm_B.mp4",
     "desc": "độ nảy của hiệu ứng node xuất hiện (ít nảy vs nảy rõ)"},
    {"id": "ptspring", "aspect": "motion",
     "knob": "treatments.process-timeline.spring.damping",
     "a": "18", "b": "4",
     "a_file": "vs_pt_A.mp4", "b_file": "vs_pt_B.mp4",
     "desc": "độ nảy của các bước trong timeline quy trình"},
    {"id": "accentfix", "aspect": "color",
     "knob": "colors.amber (visibility)",
     "a": "broken(invisible)", "b": "#f2b84b",
     "a_file": "fixtest_A.mp4", "b_file": "fixtest_B.mp4",
     "desc": "màu nhấn amber: mất hẳn vs hiển thị"},
    {"id": "amberhue", "aspect": "color",
     "knob": "colors.amber",
     "a": "#f2b84b", "b": "#ff4d6d",
     "a_file": "knob_baseline.mp4", "b_file": "knob_colors_amber.mp4",
     "desc": "sắc màu nhấn: vàng amber vs đỏ hồng"},
    {"id": "glow", "aspect": "color",
     "knob": "treatments.semantic-diagram.node.glow",
     "a": "18", "b": "60",
     "a_file": "knob_baseline.mp4", "b_file": "knob_node_glow.mp4",
     "desc": "độ phát sáng của node (mềm vs mạnh)"},
    {"id": "titlelong", "aspect": "text",
     "knob": "treatments.chapter-card.title.fontSizeLong",
     "a": "82", "b": "110",
     "a_file": "vs_cc_A.mp4", "b_file": "vs_cc_B.mp4",
     "desc": "cỡ chữ tiêu đề chương (nhỏ vừa vs lớn)"},
    {"id": "accentline", "aspect": "composition",
     "knob": "treatments.chapter-card.accentLine.maxWidth",
     "a": "190", "b": "340",
     "a_file": "vs_cc2_A.mp4", "b_file": "vs_cc2_B.mp4",
     "desc": "độ rộng gạch nhấn dưới tiêu đề (ngắn vs dài)"},
]
