...
```json
[
  {"id": "typo-001", "principle": "All text elements use bold weight (900+) with visual effects (stroke, gradient fill, or shadow)", "scope": "global", "category": "typography", "direction": "bolder+effects", "source": "user:2026-08-22", "confidence": "high", "verified": 0, "rejected": 0, "promoted": false, "status": "ACTIVE"},
  {"id": "col-001", "principle": "Colors are vivid, saturated and high-contrast — never washed out or muted; accent elements must pop against the background", "scope": "global", "category": "color", "direction": "more-vivid+higher-contrast", "source": "user:2026-08-22", "confidence": "high", "verified": 0, "rejected": 0, "promoted": false, "status": "ACTIVE"},
  {"id": "col-002", "principle": "Use gradients and color transitions instead of flat single-color fills — titles, lines, bars and borders all benefit from gradient treatment", "scope": "global", "category": "color", "direction": "gradients+transitions", "source": "user:2026-08-22", "confidence": "high", "verified": 0, "rejected": 0, "promoted": false, "status": "ACTIVE"},
  {"id": "comp-001", "principle": "Lines and connectors are organic curves (bezier paths, brush-like strokes), not mechanical straight lines", "scope": "global", "category": "composition", "direction": "organic-curves", "source": "user:2026-08-22", "confidence": "high", "verified": 0, "rejected": 0, "promoted": false, "status": "ACTIVE"},
