...
> Sinh tự động lúc 2026-08-21T22:30 bởi generate_review_doc.py.
> Nguồn: 2 video Isaac, 32 candidates thô.
...
|---|---|---|
| accent-area | 10 | GỘP + DUYỆT |
| composition | 2 | GHI NHẬN |
| junk | 2 | BỎ |
| motion | 5 | HOÃN (F4) |
| other | 1 | XEM TỪNG CÁI |
| pacing | 1 | GHI NHẬN |
| text-hierarchy | 11 | DUYỆT + CYCLE |
